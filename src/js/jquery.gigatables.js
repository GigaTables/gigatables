...
//      console.log(jsonStruct);
        ...
        function setTableRows(sets, json, jsonSearch) {
            var tBody = '', jsonStruct = json;
            var hThs = sets.headThs, fThs = sets.footThs, hV, fV;
            // set ths left from btn
            hThs.each(function () {
                var $obj = $(this);
                hV = $obj.text();
                $obj.html('<div class="gt_th_box">' + hV + '</div>');
            });
            fThs.each(function () {
                var $obj = $(this);
                fV = $obj.text();
                $obj.html('<div class="gt_th_box">' + fV + '</div>');
            });
            // =============
